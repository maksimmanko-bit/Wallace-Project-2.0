            ...
            <div class="stock-note-item ${note.type === 'Install' ? 'install' : 'supply'}" data-note-id="${escapeHtml(note.id)}">
                <div class="stock-note-header">
                    ...
                    <div class="stock-note-actions">
                        ${note.qty ? `<button type="button" class="btn btn-secondary stock-note-return-btn" onclick="returnStockNoteToStock('${escapeHtml(item.id)}', '${escapeHtml(note.id)}')" title="Return this sold quantity back to stock"><i class="fa-solid fa-rotate-left"></i> Return to Stock</button>` : ''}
